...
class Game extends UI {
  ...
  #newGame(
    ...
    this.#buttons.reset.changeEmotions('neutral');
    ...
    if (!isWin) {
      ...
      this.#buttons.reset.changeEmotions('negative');
      this.#modal.setText();
      setTimeout(this.#modal.toggleModal(), 1000);
      return;
    }
    ...
    this.#buttons.reset.changeEmotions('positive');
    this.#modal.setText();
